...
class CGI
  ...
  #
  # source://cgi//cgi/core.rb#850
  def initialize(options = T.unsafe(nil), &block); end

  # Return the accept character set for this CGI instance.
  #
  # source://cgi//cgi/core.rb#769
  ...
  #
  # source://cgi//cgi/core.rb#383
  def print(*options); end

  private

  # source://cgi//cgi/core.rb#218
  def _header_for_hash(options); end

  # source://cgi//cgi/core.rb#278
  def _header_for_modruby(buf); end

  # source://cgi//cgi/core.rb#202
  def _header_for_string(content_type); end

  # source://cgi//cgi/core.rb#191
  def _no_crlf_check(str); end

  # Synonym for ENV.
  #
  # source://cgi//cgi/core.rb#59
  def env_table; end

  # Synonym for $stdin.
  #
  # source://cgi//cgi/core.rb#64
  def stdinput; end

  # Synonym for $stdout.
  #
  # source://cgi//cgi/core.rb#69
  def stdoutput; end

  class << self
    # Return the accept character set for all new CGI instances.
    #
    # source://cgi//cgi/core.rb#759
    def accept_charset; end

    # Set the accept character set for all new CGI instances.
    #
    # source://cgi//cgi/core.rb#764
...
class CGI::Cookie < ::Array
  ...
  #
  # source://cgi//cgi/cookie.rb#75
  def initialize(name = T.unsafe(nil), *value); end

  # Domain for which this cookie applies, as a +String+
  #
  # source://cgi//cgi/cookie.rb#124
  def domain; end

  # Set domain for which this cookie applies
  #
  # source://cgi//cgi/cookie.rb#126
  def domain=(str); end

  # Time at which this cookie expires, as a +Time+
  #
  # source://cgi//cgi/cookie.rb#134
  def expires; end
  ...
  #
  # source://cgi//cgi/cookie.rb#161
  def httponly=(val); end

  # A summary of cookie string.
  #
  # source://cgi//cgi/cookie.rb#202
  def inspect; end

  # Name of this cookie, as a +String+
  #
  # source://cgi//cgi/cookie.rb#104
  def name; end

  # Set name of this cookie
  #
  # source://cgi//cgi/cookie.rb#106
  def name=(str); end

  # Path for which this cookie applies, as a +String+
  #
  # source://cgi//cgi/cookie.rb#114
  def path; end

  # Set path for which this cookie applies
  #
  # source://cgi//cgi/cookie.rb#116
  def path=(str); end

  # True if this cookie is secure; false otherwise
  #
  # source://cgi//cgi/cookie.rb#136
  def secure; end
  ...
  # +val+ must be a boolean.
  #
  # source://cgi//cgi/cookie.rb#153
  def secure=(val); end

  # Convert the Cookie to its string representation.
  #
  # source://cgi//cgi/cookie.rb#166
  def to_s; end

  # Returns the value or list of values for this cookie.
  #
  # source://cgi//cgi/cookie.rb#141
  def value; end

  # Replaces the value of this cookie with a new value or list of values.
  #
  # source://cgi//cgi/cookie.rb#146
  def value=(val); end
...
module CGI::QueryExtension
  ...
  #
  # source://cgi//cgi/core.rb#714
  def [](key); end

  # source://cgi//cgi/core.rb#448
  def accept; end
  ...
  # source://cgi//cgi/core.rb#603
  def create_body(is_large); end

  # Get the uploaded files as a hash of name=>values pairs
  #
  # source://cgi//cgi/core.rb#471
  def files; end
  ...
  # values is an Array.
  #
  # source://cgi//cgi/core.rb#468
  def params; end

  # Set all the parameters.
  #
  # source://cgi//cgi/core.rb#474
  def params=(hash); end
  ...
  #
  # source://cgi//cgi/core.rb#454
  def raw_cookie; end

  # Get the raw RFC2965 cookies as a string.
  #
  # source://cgi//cgi/core.rb#459
  def raw_cookie2; end
  ...
  #
  # source://cgi//cgi/core.rb#661
  def initialize_query; end

  # offline mode. read name=value pairs on standard input.
  #
  # source://cgi//cgi/core.rb#626
