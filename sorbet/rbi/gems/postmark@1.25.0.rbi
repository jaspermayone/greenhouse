...
class Postmark::AccountApiClient < ::Postmark::Client
  ...
  # source://postmark//lib/postmark/account_api_client.rb#148
  def get_data_removal_status(id); end
  ...
  # source://postmark//lib/postmark/account_api_client.rb#152
  def request_data_removal(attributes = T.unsafe(nil)); end
...
class Postmark::Bounce
  ...
  #
  # source://postmark//lib/postmark/bounce.rb#9
  ...
  # @return [Boolean]
  #
  # source://postmark//lib/postmark/bounce.rb#45
  ...
  class << self
    # source://postmark//lib/postmark/bounce.rb#54
