...
class Rack::CommonLogger
  # source://rack/3.0.11/lib/rack/common_logger.rb#29
  def initialize(app, logger = T.unsafe(nil)); end

  # source://sinatra//lib/sinatra/base.rb#264
  def call(env); end

  # source://rack/3.0.11/lib/rack/common_logger.rb#41
  def call_without_check(env); end

  private

  # source://rack/3.0.11/lib/rack/common_logger.rb#83
  def extract_content_length(headers); end

  # source://rack/3.0.11/lib/rack/common_logger.rb#52
...
class Sinatra::Application < ::Sinatra::Base
  class << self
    ...
    # source://sinatra//lib/sinatra/base.rb#2061
    def run; end
...
class Sinatra::Request < ::Rack::Request
  ...
  # source://rack/3.0.11/lib/rack/request.rb#410
  def secure?; end
