...
class Mail::Message
  ...
  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#129
  def body_html; end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#137
  def body_text; end
  ...
  def deliver(*_arg0, **_arg1, &_arg2); end

  # source://mail/2.8.1/lib/mail/message.rb#267
  def deliver!; end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#4
  def delivered; end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#4
  def delivered=(_arg0); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#6
  def delivered?; end
  ...
  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#147
  def export_attachments; end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#151
  ...
  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#125
  def html?; end
  ...
  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#75
  def message_stream(val = T.unsafe(nil)); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#80
  def message_stream=(val); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#36
  def metadata(val = T.unsafe(nil)); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#44
  ...
  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#55
  def postmark_attachments; end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#48
  ...
  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#88
  def prerender; end
  ...
  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#10
  def tag(val = T.unsafe(nil)); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#14
  def tag=(val); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#64
  def template_alias(val = T.unsafe(nil)); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#70
  def template_model(model = T.unsafe(nil)); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#69
  def template_model=(_arg0); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#84
  def templated?; end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#117
  def text?; end
  ...
  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#161
  ...
  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#18
  def track_links(val = T.unsafe(nil)); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#23
  def track_links=(val); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#27
  def track_opens(val = T.unsafe(nil)); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#32
  ...
  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#172
  def export_native_attachments; end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#168
  def pack_attachment_data(data); end

  # source://postmark/1.25.0/lib/postmark/message_extensions/mail.rb#183
