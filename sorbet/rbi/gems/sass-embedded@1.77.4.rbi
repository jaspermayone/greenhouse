...
class Sass::Compiler::Host::LoggerRegistry
  ...
  # source://sass-embedded//lib/sass/compiler/host/logger_registry.rb#32
  def log(event); end
  ...
  # source://sass-embedded//lib/sass/compiler/host/logger_registry.rb#49
  def warn(event); end
end
...
module Sass::Logger::Silent
  ...
  def warn(message, deprecation: T.unsafe(nil), deprecation_type: T.unsafe(nil), span: T.unsafe(nil), stack: T.unsafe(nil)); end
