...
class Danger::AzurePipelines < ::Danger::CI
  ...
  #
  # source://danger//lib/danger/ci_source/azure_pipelines.rb#55
  def initialize(env); end

  # source://danger//lib/danger/ci_source/azure_pipelines.rb#45
  def supported_request_sources; end

  class << self
    # @return [Boolean]
    #
    # source://danger//lib/danger/ci_source/azure_pipelines.rb#32
    def validates_as_ci?(env); end

    # @return [Boolean]
    #
    # source://danger//lib/danger/ci_source/azure_pipelines.rb#41
    def validates_as_pr?(env); end
  end
end
...
#
# source://danger//lib/danger/ci_source/custom_ci_with_github.rb#21
class Danger::CustomCIWithGithub < ::Danger::CI
  # @return [CustomCIWithGithub] a new instance of CustomCIWithGithub
  #
  # source://danger//lib/danger/ci_source/custom_ci_with_github.rb#35
  def initialize(env); end

  # source://danger//lib/danger/ci_source/custom_ci_with_github.rb#31
  def supported_request_sources; end

  class << self
    # @return [Boolean]
    #
    # source://danger//lib/danger/ci_source/custom_ci_with_github.rb#22
    def validates_as_ci?(env); end

    # @return [Boolean]
    #
    # source://danger//lib/danger/ci_source/custom_ci_with_github.rb#26
    def validates_as_pr?(env); end
  end
end
...
class Danger::RequestSources::BitbucketCloud < ::Danger::RequestSources::RequestSource
  ...
  # source://danger//lib/danger/request_sources/bitbucket_cloud.rb#160
  ...
  # source://danger//lib/danger/request_sources/bitbucket_cloud.rb#136
  def update_inline_comments_for_kind!(kind, messages, danger_id: T.unsafe(nil)); end

  # source://danger//lib/danger/request_sources/bitbucket_cloud.rb#93
...
class Danger::RequestSources::GitHub < ::Danger::RequestSources::RequestSource
  ...
  # source://danger//lib/danger/request_sources/github/github.rb#282
  ...
  # source://danger//lib/danger/request_sources/github/github.rb#472
  ...
  #
  # source://danger//lib/danger/request_sources/github/github.rb#483
  ...
  # source://danger//lib/danger/request_sources/github/github.rb#378
  ...
  # source://danger//lib/danger/request_sources/github/github.rb#454
  def markdown_link_to_message(message, hide_link); end
  ...
  #
  # source://danger//lib/danger/request_sources/github/github.rb#465
  def organisation; end

  # See the tests for examples of data coming in looks like
  #
  # source://danger//lib/danger/request_sources/github/github.rb#442
  def parse_message_from_row(row); end
  ...
  # source://danger//lib/danger/request_sources/github/github.rb#309
  ...
  # source://danger//lib/danger/request_sources/github/github.rb#517
  def inline_violations_group(warnings: T.unsafe(nil), errors: T.unsafe(nil), messages: T.unsafe(nil), markdowns: T.unsafe(nil)); end

  # source://danger//lib/danger/request_sources/github/github.rb#536
  def merge_violations(*violation_groups); end

  # source://danger//lib/danger/request_sources/github/github.rb#508
  ...
  # @return [Boolean]
  #
  # source://danger//lib/danger/request_sources/github/github.rb#504
...
class Git::Base
  # source://git/1.19.1/lib/git/base.rb#112
  def initialize(options = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#276
  def add(paths = T.unsafe(nil), **options); end

  # source://git/1.19.1/lib/git/base.rb#437
  def add_remote(name, url, opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#484
  def add_tag(name, *options); end

  # source://git/1.19.1/lib/git/base.rb#508
  def apply(file); end

  # source://git/1.19.1/lib/git/base.rb#514
  def apply_mail(file); end

  # source://git/1.19.1/lib/git/base.rb#495
  def archive(treeish, file = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#613
  def cat_file(objectish); end

  # source://git/1.19.1/lib/git/base.rb#134
  def chdir; end

  # source://git/1.19.1/lib/git/base.rb#359
  def checkout(*args, **options); end

  # source://git/1.19.1/lib/git/base.rb#364
  def checkout_file(version, file); end

  # source://git/1.19.1/lib/git/base.rb#552
  def checkout_index(opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#305
  def clean(opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#346
  def commit(message, opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#353
  def commit_all(message, opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#145
  def config(name = T.unsafe(nil), value = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#618
  def current_branch; end

  # source://git/1.19.1/lib/git/base.rb#490
  def delete_tag(name); end

  # source://git/1.19.1/lib/git/base.rb#324
  def describe(committish = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#161
  def dir; end

  # source://git/1.19.1/lib/git/base.rb#408
  def each_conflict(&block); end

  # source://git/1.19.1/lib/git/base.rb#370
  def fetch(remote = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#504
  def gc; end

  # source://git/1.19.1/lib/git/base.rb#253
  def grep(string, path_limiter = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#166
  def index; end

  # source://git/1.19.1/lib/git/base.rb#210
  def is_branch?(branch); end

  # source://git/1.19.1/lib/git/base.rb#198
  def is_local_branch?(branch); end

  # source://git/1.19.1/lib/git/base.rb#204
  def is_remote_branch?(branch); end

  # source://git/1.19.1/lib/git/base.rb#218
  def lib; end

  # source://git/1.19.1/lib/git/base.rb#574
  def ls_files(location = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#609
  def ls_tree(objectish); end

  # source://git/1.19.1/lib/git/base.rb#403
  ...
  # source://git/1.19.1/lib/git/base.rb#418
  def pull(remote = T.unsafe(nil), branch = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#396
  def push(*args, **options); end

  # source://git/1.19.1/lib/git/base.rb#556
  def read_tree(treeish, opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#423
  def remotes; end

  # source://git/1.19.1/lib/git/base.rb#281
  def remove(path = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#457
  def remove_remote(name); end

  # source://git/1.19.1/lib/git/base.rb#500
  def repack; end

  # source://git/1.19.1/lib/git/base.rb#172
  def repo; end

  # source://git/1.19.1/lib/git/base.rb#177
  def repo_size; end

  # source://git/1.19.1/lib/git/base.rb#288
  def reset(commitish = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#293
  def reset_hard(commitish = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#334
  def revert(commitish = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#605
  def revparse(objectish); end

  # source://git/1.19.1/lib/git/base.rb#281
  def rm(path = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#187
  def set_index(index_file, check = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#448
  def set_remote_url(name, url); end

  # source://git/1.19.1/lib/git/base.rb#192
  def set_working(work_dir, check = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#523
  def show(objectish = T.unsafe(nil), path = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#462
  def tags; end

  # source://git/1.19.1/lib/git/base.rb#569
  def update_ref(branch, commit); end

  # source://git/1.19.1/lib/git/base.rb#529
  def with_index(new_index); end

  # source://git/1.19.1/lib/git/base.rb#537
  def with_temp_index(&blk); end

  # source://git/1.19.1/lib/git/base.rb#589
  def with_temp_working(&blk); end

  # source://git/1.19.1/lib/git/base.rb#578
  def with_working(work_dir); end

  # source://git/1.19.1/lib/git/base.rb#564
  def write_and_commit_tree(opts = T.unsafe(nil)); end

  # source://git/1.19.1/lib/git/base.rb#560
  def write_tree; end

  class << self
    # source://git/1.19.1/lib/git/base.rb#16
    def bare(git_dir, options = T.unsafe(nil)); end

    # source://git/1.19.1/lib/git/base.rb#22
    def clone(repository_url, directory, options = T.unsafe(nil)); end

    # source://git/1.19.1/lib/git/base.rb#36
    def config; end

    # source://git/1.19.1/lib/git/base.rb#41
    def init(directory = T.unsafe(nil), options = T.unsafe(nil)); end

    # source://git/1.19.1/lib/git/base.rb#80
    def open(working_dir, options = T.unsafe(nil)); end

    # source://git/1.19.1/lib/git/base.rb#29
    def repository_default_branch(repository, options = T.unsafe(nil)); end

    # source://git/1.19.1/lib/git/base.rb#67
    def root_of_worktree(working_dir); end

    private

    # source://git/1.19.1/lib/git/base.rb#706
    def normalize_index(options); end

    # source://git/1.19.1/lib/git/base.rb#634
    def normalize_paths(options, default_working_directory: T.unsafe(nil), default_repository: T.unsafe(nil), bare: T.unsafe(nil)); end

    # source://git/1.19.1/lib/git/base.rb#686
    def normalize_repository(options, default:, bare: T.unsafe(nil)); end

    # source://git/1.19.1/lib/git/base.rb#653
