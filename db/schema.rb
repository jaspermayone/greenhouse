...
ActiveRecord::Schema[7.1].define(version: 20_240_306_220_426) do
  ...
  create_table 'console1984_commands', force: :cascade do |t|
    ...
    t.index %w[session_id created_at sensitive_access_id], name: 'on_session_and_sensitive_chronologically'
  end
  ...
  create_table 'console1984_sessions', force: :cascade do |t|
    ...
    t.index %w[user_id created_at], name: 'index_console1984_sessions_on_user_id_and_created_at'
  end
